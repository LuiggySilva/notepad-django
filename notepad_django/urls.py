"""notepad_django URL Configuration
...
urlpatterns = [ 
    ...
    path('note/<int:pk>', notepad_view, name='url_view'),                      
    path('create/', notepad_create, name='url_create'),
    path('remove/<int:pk>', notepad_remove, name='url_remove'),
