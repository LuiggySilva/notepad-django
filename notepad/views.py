...
def notepad_view(request, pk):
    ...
    return render(request, 'notepad/notepad_view.html', data)
...
def notepad_create(request):  
    ...
    data['form'] = form             
    return render(request, 'notepad/notepad_manage.html', data)
...
def notepad_list(request):                           
    ...
    return render(request, 'notepad/notepad_list.html', data)
